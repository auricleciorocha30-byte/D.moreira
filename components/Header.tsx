  ...
  return (
    <header className="bg-yellow-400 pt-8 pb-14 px-6 rounded-b-[3rem] shadow-xl relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-lg mx-auto">
        <div className="bg-black w-16 h-16 rounded-full mb-4 shadow-2xl flex items-center justify-center shrink-0">
          <GasIcon className="w-8 h-8 text-yellow-400" size={32} />
        </div>
        <h1 className="text-4xl font-black text-black tracking-tight mb-1">
          {STORE_INFO.name}
        </h1>
        <p className="text-black font-bold uppercase tracking-[0.2em] text-[10px] mb-4 opacity-80">
          {STORE_INFO.slogan}
        </p>
        <div className="bg-black text-white px-4 py-1.5 rounded-full inline-flex items-center gap-2 shadow-lg">
